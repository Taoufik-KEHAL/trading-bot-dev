...
TRADE_SIZE_USDT = 10
FEE_RATE = 0.001
STRATEGY_NAME = "V9_ADAPTIVE_MARKET_REGIME"
...
def plot_trade(symbol, df, trade, trade_number, output_dir, candles_before, candles_after):
    ...
    price_ax.set_title(
        f"{symbol} V9 {trade['side']} {trade['regime']} trade {trade_number:04d} - {trade['result']} "
...
def parse_args():
    parser = argparse.ArgumentParser(description="Backtest V9 adaptive market-regime strategy.")
    parser.add_argument(
        "--timeframe",
    ...
    parser.add_argument(
        "--chart-dir",
        default="charts_v9_adaptive_market",
