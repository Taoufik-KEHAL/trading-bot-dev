...
TRADE_SIZE_USDT = 10
FEE_RATE = 0.001
STRATEGY_NAME = "V7_SHORT_EDGE_BTC_REGIME_TRAIL"
...
def plot_trade(symbol, df, trade, trade_number, output_dir, candles_before, candles_after):
    ...
    price_ax.set_title(
        f"{symbol} V7 {trade['side']} trade {trade_number:04d} - {trade['result']} "
...
def parse_args():
    parser = argparse.ArgumentParser(description="Backtest V7 short-edge BTC-regime strategy.")
    parser.add_argument(
        "--plot-trades",
        action="store_true",
