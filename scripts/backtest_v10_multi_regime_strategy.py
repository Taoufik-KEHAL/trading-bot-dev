...
TRADE_SIZE_USDT = 10
FEE_RATE = 0.001
STRATEGY_NAME = "V10_MULTI_REGIME_ADAPTIVE_SYSTEM"
...
def plot_trade(symbol, df, trade, trade_number, output_dir, candles_before, candles_after):
    ...
    price_ax.set_title(
        f"{symbol} V10 {trade['side']} {trade['regime']} trade {trade_number:04d} - {trade['result']} "
...
def parse_args():
    parser = argparse.ArgumentParser(description="Backtest V10 multi-regime adaptive strategy.")
    parser.add_argument(
        "--timeframe",
    ...
    parser.add_argument(
        "--chart-dir",
        default="charts_v10_multi_regime",
