...
FEE_RATE = 0.001
STRATEGY_VERSION = "V3"
STRATEGY_NAME = f"{STRATEGY_VERSION}_STRONG_EMA_TREND_RSI_VOLUME_ATR"
...
RISK_REWARD = 1.5
SWING_LOOKBACK = 10
EMA_MID_SLOPE_LOOKBACK = 12
EMA_TREND_SLOPE_LOOKBACK = 24
...
def parse_args():
    parser = argparse.ArgumentParser(description="Backtest a stricter EMA trend strategy with fees.")
    parser.add_argument(
        "--plot-trades",
        action="store_true",
